...
class MetaTrainer(Trainer):
    ...
    def train_one_step(self):
        ...
        batch_ent_emb, batch_rel_emb, time_emb = self.model(batch_sup_g, batch_pattern_g)
        ...
        for batch_i, data in enumerate(batch):
            ...
            loss = self.get_loss(que_tri, que_neg_tail_ent, que_neg_head_ent, ent_emb, rel_emb, time_emb)
